...
a = Analysis( # type: ignore
    ...
    pathex=[],
    binaries=[],
    datas=[("packaging", "packaging"), ("recovery", "recovery")],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
...
if is_darwin:
    ...
    copytree("./recovery/en.lproj", app_bundle_path / "Contents" / "Resources" / "en.lproj", dirs_exist_ok=True)
    ...
    (executable_path / "Fuji").chmod(0o755)
